...
printf("TEST_SGEMM_NAIVE Elapsed time: %f milliseconds GFlops=%f\n",                                \
       mtime, ((float) NUMBER*2*m*n*r)/(mtime*1e6));                                                \
}

#define TEST_SGEMM_16X6                                                                             \
{                                                                                                   \
gettimeofday(&start, NULL);                                                                         \
for(int i = 0; i < NUMBER; i++) {                                                                   \
sgemm_16x6(CblasRowMajor, CblasNoTrans, CblasNoTrans,                                               \
        m, n, r, 1.0, x, r, y, n, 0.0, out1, n);                                                           \
}                                                                                                   \
gettimeofday(&end, NULL);                                                                           \
long seconds  = end.tv_sec  - start.tv_sec;                                                         \
long useconds = end.tv_usec - start.tv_usec;                                                        \
float mtime = ((seconds) * 1000 + useconds/1000.0);                                                 \
printf("TEST_SGEMM_16X6 Elapsed time: %f milliseconds GFlops=%f\n", mtime, ((float) NUMBER*2*m*n*r)/(mtime*1e6));   \
}

#define TEST_SGEMM_16X6_BLOCK                                                                       \
for(int i = 0; i < m; i++) {                                                                        \
for(int j = 0; j < n; j++) {                                                                        \
out1[i*n+j] = 0.0;                                                                                  \
}                                                                                                   \
...
gettimeofday(&start, NULL);                                                                         \
for(int i = 0; i < NUMBER; i++) {                                                                   \
sgemm_16x6_block(CblasRowMajor, CblasNoTrans, CblasNoTrans,                                         \
        m,n,r, 1.0,x,r,y,n,0.0, out1, n);                                                           \
}                                                                                                   \
gettimeofday(&end, NULL);                                                                           \
long seconds  = end.tv_sec  - start.tv_sec;                                                         \
long useconds = end.tv_usec - start.tv_usec;                                                        \
float mtime = ((seconds) * 1000 + useconds/1000.0);                                                 \
printf("TEST_SGEMM_16X6_BLOCK Elapsed time: %f milliseconds GFlops=%f\n", mtime, ((float) NUMBER*2*m*n*r)/(mtime*1e6));   \
}

#define TEST_SGEMM_16X6_BLOCK_PARALLEL                                                              \
for(int i = 0; i < m; i++) {                                                                        \
for(int j = 0; j < n; j++) {                                                                        \
out1[i*n+j] = 0.0;                                                                                  \
}                                                                                                   \
...
gettimeofday(&start, NULL);                                                                         \
for(int i = 0; i < NUMBER; i++) {                                                                   \
sgemm_16x6_block_parallel(CblasRowMajor, CblasNoTrans, CblasNoTrans,                                \
        m,n,r, 1.0,x,r,y,n,0.0, out1, n);                                                           \
}                                                                                                   \
gettimeofday(&end, NULL);                                                                           \
long seconds  = end.tv_sec  - start.tv_sec;                                                         \
long useconds = end.tv_usec - start.tv_usec;                                                        \
float mtime = ((seconds) * 1000 + useconds/1000.0);                                                 \
printf("TEST_SGEMM_16X6_BLOCK_PARALLEL Elapsed time: %f milliseconds GFlops=%f\n", mtime, ((float) NUMBER*2*m*n*r)/(mtime*1e6));   \
}

#define TEST_CBLAS_SGEMM                                                                            \
{                                                                                                   \
gettimeofday(&start, NULL);                                                                         \
for(int i = 0; i < NUMBER; i++) {                                                                   \
...
long useconds = end.tv_usec - start.tv_usec;                                                        \
float mtime = ((seconds) * 1000 + useconds/1000.0);                                                 \
printf("TEST_CBLAS_SGEMM Elapsed time: %f milliseconds GFlops=%f\n", mtime, ((float) NUMBER*2*m*n*r)/(mtime*1e6));   \
}
...
int main() {
    ...
    TEST_CBLAS_SGEMM
    TEST_SGEMM_16X6
    TEST_SGEMM_16X6_BLOCK
    TEST_SGEMM_16X6_BLOCK_PARALLEL
    TEST_SGEMM_NAIVE
