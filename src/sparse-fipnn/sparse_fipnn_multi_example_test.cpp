...
template <typename T>
int32_t ComputeSparseFipnnSharedMemoryMultiExample(cudaStream_t stream, const void* const* input, T* output, void* workspace,
...
void InferenceMultiExample() {
    ...
    std::string data_dir = "/data/plat/hungryhe/dataset/300_9003_input_dataset/";
