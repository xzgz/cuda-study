...
int main(int argc, char **argv)
{
    ...
    // cpu reduction
    iStart = seconds();
    int cpu_sum = sumReduce(tmp, size);
    iElaps = seconds() - iStart;
    printf("cpu sum reduce       elapsed %d ms cpu_sum: %d\n", int(1000 * iElaps), cpu_sum);
    iStart = seconds();
    cpu_sum = recursiveReduce(tmp, size);
    iElaps = seconds() - iStart;
    printf("cpu recursive reduce elapsed %d ms cpu_sum: %d\n", int(1000 * iElaps), cpu_sum);
    ...
    printf("gpu Neighbored  elapsed %d ms gpu_sum: %d <<<grid %d block "
           "%d>>>\n", int(1000 * iElaps), gpu_sum, grid.x, block.x);
    ...
    printf("gpu Neighbored2 elapsed %d ms gpu_sum: %d <<<grid %d block "
           "%d>>>\n", int(1000 * iElaps), gpu_sum, grid.x, block.x);
    ...
    printf("gpu Interleaved elapsed %d ms gpu_sum: %d <<<grid %d block "
           "%d>>>\n", int(1000 * iElaps), gpu_sum, grid.x, block.x);
    ...
    printf("gpu Unrolling2  elapsed %d ms gpu_sum: %d <<<grid %d block "
           "%d>>>\n", int(1000 * iElaps), gpu_sum, grid.x / 2, block.x);
    ...
    printf("gpu Unrolling4  elapsed %d ms gpu_sum: %d <<<grid %d block "
           "%d>>>\n", int(1000 * iElaps), gpu_sum, grid.x / 4, block.x);
    ...
    printf("gpu Unrolling8  elapsed %d ms gpu_sum: %d <<<grid %d block "
           "%d>>>\n", int(1000 * iElaps), gpu_sum, grid.x / 8, block.x);
    ...
    printf("gpu UnrollWarp8 elapsed %d ms gpu_sum: %d <<<grid %d block "
           "%d>>>\n", int(1000 * iElaps), gpu_sum, grid.x / 8, block.x);
    ...
    printf("gpu Cmptnroll8  elapsed %d ms gpu_sum: %d <<<grid %d block "
           "%d>>>\n", int(1000 * iElaps), gpu_sum, grid.x / 8, block.x);
    ...
    printf("gpu Cmptnroll   elapsed %d ms gpu_sum: %d <<<grid %d block "
           "%d>>>\n", int(1000 * iElaps), gpu_sum, grid.x / 8, block.x);
